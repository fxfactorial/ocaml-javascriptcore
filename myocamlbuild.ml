(* OASIS_START *)
(* DO NOT EDIT (digest: 2325700f600f27e9ae8c436b64d17efc) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_library_javascriptcore_cclib"; "link"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.ETest ("system", "macosx"),
                 S
          ...
          (["oasis_library_javascriptcore_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.ETest ("system", "macosx"),
                 S [A "-framework"; A "JavaScriptCore"; A "-lc++"]);
               (OASISExpr.ENot (OASISExpr.ETest ("system", "macosx")),
                 S
                   [
                      A "-ljavascriptcoregtk-3.0";
